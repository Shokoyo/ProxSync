                ...
                <div id="signout-row" style="align-self: center; margin-right: 16px; margin-left: auto;">
                    ...
                    <div class="mdc-simple-menu mdc-simple-menu--open-from-top-right" tabindex="-1" id="notification-menu" style="top:64px;right:72px;">
                        <ul class="mdc-simple-menu__items mdc-list" role="menu" aria-hidden="true">
                            ...
                            %>
                            <li class="mdc-list-item profile-list" role="menuitem" tabindex="0">
                                <span style="align-self:center"><a href="javascript:void(0)" onclick="watchNext('<%=n.getKey()%>');return false;" style="text-decoration:none;color:inherit;"><%=n.getTitle()%>: <%=n.getLatestEpisode()%>/<%=n.getEpisodeCount()%></a><i onclick="removeNotification('<%=n.getKey()%>');return false;" class="material-icons remove-notification">clear</i></span>
                            </li>
